                ...
                <div class="sidebar">
                    <div class="category-widget widget">
                        ...
                        <ul class="category-list">
                            ...
                            <li>Tyco-Raychem</li>
                            <li>Siemens</li>
                            <li>Optical Cable Corporation</li>
                            <li>Thermon</li>
                            <li>La Marche</li>
                            <li>Crouse Hinds</li>
                            <li>Hawke</li>
                    ...
                    <div class="category-widget widget">
                        <h2>Servicios</h2>
                        <ul class="category-list">
                            <li>Asesor&iacute;a t&eacute;cnica a trav&eacute;s de personal especializado de f&aacute;brica</li>
                            <li>Stock Local de Mercader&iacute;a</li>
