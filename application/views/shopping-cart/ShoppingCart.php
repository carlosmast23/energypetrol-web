...
class ShoppingCart extends DBController
{
    ...
    {
        $query = "SELECT tbl_product.*, tbl_cart.id as cart_id,tbl_cart.quantity,tbl_cart.member_id as ped_id FROM tbl_product, tbl_cart WHERE 
    ...
    {
        $query = "INSERT INTO tbl_order (customer_id, amount, name, email, telf, payment_type, order_status, order_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $params = array(
            ...
            array(
                "param_type" => "s",
                "param_value" => $customer_detail["telf"]
            ),
            array(
                "param_type" => "s",
                "param_value" => "PAYPAL"
    ...
    function insertOrder1($customer_detail, $member_id, $amount)
    {
